...
## <a name="Modes">Vim Modes</a> ##

- [Normal Mode](#normal-mode), **Navigation and manipulation of text**  
- [Insert Mode](#insert-mode), **Inserting new text**  
- [Visual Mode](#visual-mode), **Navigation and manipulation of text selections**  
- [Select Mode](#select-mode), **Similar to visual, but with more MS Windows-like behavior**  
- [Last Line / Command Line Mode](#last-line-mode), **For entering editor commands**  
...
### <a name="InsertMode">Mode: Insert</a> ###
...
### <a name="VisualMode">Mode: Visual</a> ###

Visual mode is for visually selecting text  

------------------------------------------------------------------------------------------------

### <a name="SelectMode">Mode: Select</a> ###

Similar to visual, but with more MS Windows-like behavior

------------------------------------------------------------------------------------------------

### <a name="LastLineMode">Mode: Last Line / Command Line</a> ###
...
### <a name="SpellChecker">Spell Checker</a> ###
...
## <a name="Cheatsheets">Cheat Sheets</a> ##
