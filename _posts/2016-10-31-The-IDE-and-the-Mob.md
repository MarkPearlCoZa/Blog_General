...
Before you start your first mob session, spend time on setting up the mob development environment (MDE). Having an MDE that works will improve the general experience a new mob has. In preparing the MDE there are a few things to cover:
